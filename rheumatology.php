                                ...
                                <div class="row">
                                    <div class="col-lg-11 col-md-12 m-auto">
                                        <div class="aboutservice-content">
                                            <h2 class="title">Rheumatology and Rheumatic Diseases</h3>
                                            </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="prt-blog-single-content">
                                <div class="entry-content">
                                    ...
                                    <div class="blog-single-title">
                                        ...
                                        <div class="col-lg-9">
<p>These are a group of auto-immune connective disorders and are growing in incidence over the years.</p>
<p>Conventional treatment is aimed at reducing inflammation and associated symptoms like pain, swelling etc and at preserving joint function by drugs that suppress the immune system. Long term use of these drugs is known to produce severe adverse effects.</p>
                                        <ul class="prt-list prt-list-style-icon-03">
                                    <li class="prt-list-li-content"> Common Rheumatologic Conditions 
                                    </li>
                                        </ul>
...
<ul class="prt-list prt-list-style-icon-03">
                                    <li class="prt-list-li-content">Ayurvedic treatment aims
                                    </li>
                                        </ul>
<ul>

                                                    <li>
                                                    Relieving pain and restoring joint function.
                                                    </li>
                                                    <li> Controlling inflammation, which is the core of the disease pathogenesis, protection of joints and preserving body and joint function.
                                                    </li>
                                                    <li> Achieving remission, preventing complications and minimizing toxic effects of medicines.
                                                    </li>
</ul>
...
<div class="info_btn mr-30 res-767-mb-15">
                                    ...
                                    <a button type="button" class="btn btn-warning" href="https://wa.me/+919061953000?text=Hi, I would like to know more about ayurveda treatment rheumatology and rheumatic diseases ">Book an Appointment</a>
