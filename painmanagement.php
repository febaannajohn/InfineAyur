                                ...
                                <div class="row">
                                    <div class="col-lg-11 col-md-12 m-auto">
                                        <div class="aboutservice-content">
                                            <h2 class="title">Pain Management</h3>
                                             </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <!-- <div class="col-lg-12"> -->
                            <div class="prt-blog-single-content">
                                ...
                                <p class="desc">Pain is a condition of abnormal state of a part of the body which can cause inconvenience or sometimes can be totally incapacitating. </div>
                                   
                                    
                                    <div class="blog-single-title">
                                        <h3>The various conditions affecting different joints include
                                        </h3>
                                        <div class="col-lg-9">
<h5>Shoulder Join</h5>
...
<p> <b>Joint problems can be caused by several issues, however, the main causes are</b></p>
...
Degeneration
                                                    ...
                                                    <li> Damage Due to Injury
                                                    </li>  
                                                                    
              <p>We provide a complete ayurvedic treatment for joint pain each and every condition using various treatments both internally and externally to reduce inflammation and to produce strength to surrounding tissues.</p>                                      
                  
              
              <div class="info_btn mr-30 res-767-mb-15">
                                   
                               
                                    <a button type="button" class="btn btn-warning" href="https://wa.me/+919061953000?text=Hi, I would like to know more about ayurveda treatment pain management">Book an Appointment</a>
